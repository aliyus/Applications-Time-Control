...
#+++++++++++++++++++++++++++++++++++++++++++++
"""
def gpDoubleT2(population, toolbox, cxpb, mutpb, ngen, stats=None,
...
#+++++++++++++++++++++++++++++++++++++++++++++
    ...
    gen=0
    hof_db=[]
    cxOver_db=[] # -------------------777777777777777777777777777777777777777777777777777777777
    B4Fitness = 0
    B4Test_Fitness = 0
    AfFitness = 0
    AfTest_Fitness = 0
...
# define a breed function as nested.
    def breed():
        ...
        # initialise ----------------77777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777
        B4Fitness = 0
        B4Test_Fitness = 0
        AfFitness = 0
        AfTest_Fitness = 0
...
#                counteval_lock.release()
                ...
                xo, yo, zo = toolbox.evaluate(cand, datatrain, datatest)
...
#    			#[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]BEGIN
#    			#WWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWW
#                if float(cand.fitness.values[0]) >= target:
##                if float(p1.testfitness[0]) >= target:
#                    #                print('Hi')
#                    if mettarget == 0:
#                        mettarget = counteval
#                        print(f'Target met: {counteval}')
#                        print(f'Test Fitness: {float(cand.fitness.values[0])}')
...
##        stats ----------------77777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777
...
#        #Destination file (local)
#        cxOver_csv = f'{report_csv[:-4]}_cxOver.csv'
#        #Export from dataframe to CSV file. Update if exists
...
#        poplnsize =  500
        counteval = 0 
        cxOver_db=[]# -------------------77777777777777777777777777777777777777777777777777777777777777777777777777
...
#+++++++++++++++++++++++++++++++++++++++++++++
"""
def gpDoubleTcx(population, toolbox, cxpb, mutpb, ngen, stats=None,
             halloffame=None, verbose=__debug__, run=1, report_csv=None, datatrain=None, datatest=None, target =None):
    """
    This algorithm uses a steadystate approach evolutionary algorithm as popularized 
    by the Darrell Whitley and Joan Kauth’s GENITOR system. The idea is to iteratively 
