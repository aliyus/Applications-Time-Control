...
def selNeighbours(individuals, k):
    """
	...
	"""
    contestants =[]
    pp1 = random.choice(individuals)
    jindex = individuals.index(pp1)

    contestants.append(pp1)
    if jindex > 0:
        contestants.append(individuals[jindex - 1])
    else:
        contestants.append(individuals[jindex + 1])
#    print(f'Size distance: {int(len(contestants[1])- len(contestants[0]))}')
    return contestants        
...
# -*- coding: utf-8 -*-
"""
Created on Fri Sep 27 18:16:44 2019
...
def selDoubleTournTime(individuals, k, fitness_size, parsimony_size, fitness_first, fit_attr="fitness"):
    """Tournament selection which use the evaluation time of the individuals in
...
#                prob = 0.5
            ...
            if ind1.evlntime[0] > ind2.evlntime[0]:
                ind1, ind2 = ind2, ind1

# -----------------------------------------
            elif ind1.evlntime[0] == ind2.evlntime[0]:
                # random selection in case of a tie
                prob = 0.5
# -----------------------------------------
#            if  (ind1.evlntime[0]*1.0001 > ind2.evlntime[0]) or (ind1.evlntime[0] == ind2.evlntime[0]):
#                # random selection if a tie OR if difference is less than 0.1%
#                prob = 0.5
# -----------------------------------------
            # Since size1 <= size2 then ind1 is selected
            # with a probability prob
...
def selDoubleTournTFL(individuals, k, fitness_size, parsimony_size, fitness_first, fit_attr="fitness"):
    """
...
#------------------------------------------    
    ...
    if fitness_first:
        ...
        tsize = partial(_sizeTournament, select=selNeighbours)
        return _fitTournament(individuals, k, tsize)
...
def selDoubleTournTFL2(individuals, k, fitness_size, parsimony_size, fitness_first, fit_attr="fitness"):
    """
	First select individuals of same size.
...
#------------------------------------------
    def _sizeTournament(individuals, k, select):
        ...
        for i in range(k):
            ...
            # The first individual has to be the shortest
            prob = parsimony_size / 2.
            ind1, ind2 = selNeighbours(individuals, k=2)
...
#                prob = 0.5
    ...
    # -----------------------------------------
            ...
            # with a probability prob
            chosen.append(ind1 if random.random() < prob else ind2)
            print(f'selectected:  {len(ind1)}, {ind1.evlntime[0]}')
            print(f'       ind2:  {len(ind2)}, {ind2.evlntime[0]}')
        return chosen
#------------------------------------------
#------------------------------------------
#------------------------------------------    
...
def selDoubleTournTFL3(individuals, k, fitness_size, parsimony_size, fitness_first, fit_attr="fitness"):
    """
	First select individuals of same size.
...
# ===========================================
#            print('')
            indT1, indT2 = selNeighbours(individuals, k=2)
            if indT1.evlntime[0] > indT2.evlntime[0]:
                indT1, indT2 = indT2, indT1

#            print(f'selectected:  {len(indT1)}, {indT1.evlntime[0]}')
#            print(f'       ind2:  {len(indT2)}, {indT2.evlntime[0]}')
            # -----------------------------------------
            indTt1, indTt2 = selNeighbours(individuals, k=2)
            if indTt1.evlntime[0] > indTt2.evlntime[0]:
                indTt1, indTt2 = indTt2, indTt1
#            print(f'selectected:  {len(indTt1)}, {indTt1.evlntime[0]}')
#            print(f'       ind2:  {len(indTt2)}, {indTt2.evlntime[0]}')
# ===========================================
            if indT1.evlntime[0] > indTt1.evlntime[0]:
                indT1, indTt1 = indTt1, indT1
# ===========================================
    # -----------------------------------------
            elif indT1.evlntime[0] == indTt1.evlntime[0]:
                # random selection in case of a tie
                prob = 0.5

            # with a probability prob
            chosen.append(indT1 if random.random() < prob else indTt1)
        return chosen
#------------------------------------------
#------------------------------------------    
    def _fitTournament(individuals, k, select):
...
"""
    ...
    def _sizeTournament(individuals, k, select):
        ...
        for i in range(k):
            ...
            ind1, ind2 = selRandom(individuals, k=2)
ind1, ind2 = [random.choice(individuals) for i in range(k)]
        ...
        parsimony_size = 1.4
            ...
            chosen.append(ind1 if random.random() < prob else ind2)
            print(ind1.evlntime[0])
            print(ind2.evlntime[0])
            print(chosen[0].evlntime[0])
            
    _sizeTournament(individuals, k, select)
...
__all__ = ['selRandom', 'selBest', 'selWorst', 'selRoulette', 'selNeighbours', 'selDoubleTournTFL2', 'selDoubleTournTFL','selDoubleTournTFL2',
           'selTournament', 'selDoubleTournament', 'selDoubleTournTime', 'selStochasticUniversalSampling',
